...
アドビカスタマーサポートでは、ドキュメントのオンラインリソースへのアクセス、ベストプラクティスのための他のエキスパートやお客様とのエンゲージメント、トラブルシューティングのヒントやテクニックのためのウェビナーシリーズ（Office Hours）を提供しています。 また、質問やケース申請のために、いくつかのチャネルが用意されています。
