---
title: Adobe Creative CloudとAdobe Document Cloudの標準サポート
description: Adobeは、Adobeのエンタープライズサブスクリプションの一部として含まれる、ビジネスをサポートするための包括的な技術リソースを提供します。 標準サポートには、24 時間 365 日対応のセルフヘルプサポートリソース (HelpX に関する記事や、Adobeコミュニティでの他のお客様との関わりなど ) へのアクセスが含まれています。
...
# Creative CloudとAdobe Document Cloudの標準サポート

![アイコン](assets/StandardBanner.png)

Adobeは、Adobeのエンタープライズサブスクリプションの一部として含まれる、ビジネスをサポートするための包括的な技術リソースを提供します。 標準サポートには、24 時間 365 日対応のセルフヘルプサポートリソース (HelpX に関する記事や、Adobeコミュニティでの他のお客様との関わりなど ) へのアクセスが含まれています。

詳細で詳細な技術製品ドキュメントと、 <http://www.adobe.com>. 標準サポートには、チャットまたは電話を通じたテクニカルサポートチームへの認証済みユーザー（管理者）への 24 時間 365 日のアクセスと、サポート Web ポータルを通じたサポートリクエストのログ記録機能も含まれています。

[PDFバージョンを表示](assets/DMeStandardSupportDatasheet_2022.pdf)
...
<tbody>
  <tr>
    ...
    <td colspan="3" rowspan="4" align="center" valign="middle"> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br>該当するAdobe製品およびサービスのサポートプランを購入したお客様は、Adobeのサポートエンジニアに対して、ケースを迅速に追跡する優先的なケースルーティングを受け取ります。</td>
  </tr>
  <tr>
...
Adobeカスタマーサポートでは、ドキュメントに関するリソースを参照し、他のエキスパートやお客様との関わり合いを図って、ベストプラクティスをご利用いただけます。 質問やケース送信には、いくつかのチャネルも使用できます
...
| リソース | 説明 |
|--- |--- |
| [Experience League](https://experienceleague.adobe.com/?lang=ja) | Experience Leagueは、Adobeのお客様がセルフヘルプチュートリアル、製品ドキュメント、講師によるトレーニング、コミュニティ、および一部のAdobe Creative Cloud製品とドキュメント製品のサポートを見つけることができる場所です。 |
