...
<tr>
  ...
  <td>
    <img alt="メンテナンスとモニタリング" src="assets/MaintenanceMonitoring.png"/>
    <div>
    <p><b>メンテナンスとモニタリング</b></p>
...
フィールドサービスは、**迅速な解決**、集中的なカスタマーサクセス、**価値実現までの時間**&#x200B;の短縮のために使用されます。 アドビサポート契約の対象となるソリューション製品で、Launch Advisory がアクティブの場合、**1 年目のフィールドサービスはありません**。
