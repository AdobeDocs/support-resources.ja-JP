...
再設計されたExperience League サポートポータルは、すべてのユーザーのデフォルトのエクスペリエンスになりました。 サポートアプリケーションにアクセスすると、自動的に再設計されたポータルに移動します。 このポータルでは、Adobe Adobeのサポートアクティビティを管理するための統合された直感的なエクスペリエンスを提供し、サポートケースのトラッキング、製品ステータスのモニタリング、ケースインサイトへのアクセス、サクセスチームとの連携などの重要な機能にすばやくアクセスできます。
...
![新しいUI](/help/adobe-support-tools-guide/assets/new-toggle-1.png)

ポータルのエクスペリエンスはどちらも同期されたままになり、サポートケースのデータと情報がエクスペリエンス間で一貫性を保つことができます。 ポータルの環境設定は、**[!UICONTROL 前のエクスペリエンスに戻る]** スイッチャーの選択に基づいて保存され、訪問するたびに最後に選択したポータル エクスペリエンスに移動します。
