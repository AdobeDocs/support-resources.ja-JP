...
Global Admin Consoleで、組織を選択し、「**[!UICONTROL 管理者]**」タブに移動して、管理者権限を追加、編集、または削除できます。 階層内の各組織はAdobe Admin Consoleです。これらのコンソールをGlobal Admin Consoleがどのようにグループ化するかについては、[Adopt global administration](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/adopt-global-administration)を参照してください。 階層全体のタスクの場合は[Global Admin Console](https://global-admin-console.adobe.com)に、1つの組織内のタスクの場合は[Adobe Admin Console](https://adminconsole.adobe.com)にログインします。
