...
Global Admin Consoleで、組織を選択し、「**[!UICONTROL 管理者]**」タブに移動して、管理者権限を追加、編集、または削除できます。 詳しくは、[&#x200B; グローバル管理の導入](https://experienceleague.adobe.com/ja/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/adopt-global-administration)を参照してください。 [Admin Consoleにログインするには、こちらに移動します](https://adminconsole.adobe.com)。
