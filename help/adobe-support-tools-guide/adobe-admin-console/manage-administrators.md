...
Global Admin Consoleで、組織を選択し、「**[!UICONTROL 管理者]**」タブに移動して、管理者権限を追加、編集、または削除できます。 詳しくは、[&#x200B; グローバル管理の導入](https://helpx.adobe.com/enterprise/global-admin-console/adopt-global-administration.html)を参照してください。 [Global Admin Console](https://global-admin-console.adobe.com/)に移動してログインします。
