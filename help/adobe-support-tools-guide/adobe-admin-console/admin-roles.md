...
| 役割 | 説明 |
|--- |--- |
| **システム管理者** | 組織のスーパーユーザー。Admin Consoleですべての管理タスクを実行できます。<br>また、管理機能を他のユーザー（製品管理者、製品プロファイル管理者、ユーザーグループ管理者、デプロイメント管理者、サポート管理者）に委任する権限もあります。 |
...
1. **[!UICONTROL ユーザーの詳細]**&#x200B;で、**管理者権限** セクションの![ アイコン ](../assets/one-console-ellipses.png)をクリックし、**[!UICONTROL 管理者権限の編集]**&#x200B;を選択します。
...
1. **[!UICONTROL ユーザーの詳細]**&#x200B;で、**[!UICONTROL 管理者権限]** セクションの右側にある![ アイコン ](../assets/one-console-ellipses.png)をクリックし、**[!UICONTROL 管理者権限を編集]**&#x200B;を選択します。
