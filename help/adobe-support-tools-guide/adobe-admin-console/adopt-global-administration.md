---
title: グローバルな経営体制の導入
description: Global Admin ConsoleがAdobe管理コンソールをどのようにグループ化するのか、子管理コンソールとは何か、アクセスをリクエストする方法について説明します。
...
Global Admin Consoleを利用するメリットと、アクセス方法をご紹介します。 [学習を増やす](#request-access-to-the-global-admin-console)。
...
子Admin Console（Global Admin Consoleでは&#x200B;*子組織*&#x200B;と呼ばれます）は、階層内の別のコンソールの下にネストされた任意のAdobe Admin Consoleです。 この意味で、Global Admin ConsoleにリンクされているAdmin Consoleのみが子コンソールであり、世界中のすべてのAdobe Admin Consoleではありません。
...
Global Admin Consoleの主な利点は次のとおりです。
...
[Global Admin Console](https://global-admin-console.adobe.com)へのアクセスをリクエストするには、Adobe担当者にお問い合わせください。
