...
>[!NOTE]
>
>[Global Admin Console](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/adopt-global-administration#request-access-to-the-global-admin-console)にアクセスできたら、最初に組織を選択して、組織の名前、ユーザーグループ、製品プロファイル、管理者、および組織ポリシーを表示および管理します。 Global Admin Consoleにログインするには、[ここをクリック ](https://global-admin-console.adobe.com/)してください。
...
組織に追加または組織から削除された管理者には、メール通知が送信されます。 組織に対する特定のポリシーの変更は、その組織の[!DNL Admin Console]に通知をもたらします。
