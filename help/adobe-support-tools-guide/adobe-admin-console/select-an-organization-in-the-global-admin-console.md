...
>[!NOTE]
>
>[Global Admin Console](https://helpx.adobe.com/enterprise/global-admin-console/adopt-global-administration.html#request-access) にアクセスできるようになったら、まず組織を選択し、その組織の名前、ユーザーグループ、製品プロファイル、管理者、および組織ポリシーを表示および管理できます。 Global Admin Consoleにログインするには、[ ここをクリック ](https://global-admin-console.adobe.com/) します。
...
- グローバル管理コンソールを使用して表示できるのは、選択した組織にリンクされているドメインのリストのみです。 選択した組織のシステム管理者の場合は、「**[!UICONTROL Admin Consoleで開く]**」を選択して [ ドメインを管理 ](https://helpx.adobe.com/enterprise/using/manage-domains-directories.html) します。 「ドメイン」タブに表示される情報については、[ スキーマのエクスポートとインポート ](https://helpx.adobe.com/enterprise/global-admin-console/export-and-import-data.html#export-and-import-schemas) を参照してください。
