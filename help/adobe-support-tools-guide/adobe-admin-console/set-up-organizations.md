...
[様が [!DNL Global Admin Console]](https://helpx.adobe.com/enterprise/global-admin-console/adopt-global-administration.html#request-access)にアクセスできるようになると、新しい組織を作成し、既存の組織を階層に追加し、組織を削除し、親組織を変更できます。
[Global Admin Consoleにログイン ](https://global-admin-console.adobe.com/)

組織とは、Adobe製品とユーザーを管理するために使用される構造です。 [[!DNL Adobe Admin Console]](https://helpx.adobe.com/jp/enterprise/using/admin-console.html)を使用すると、管理者は組織内の製品とユーザーのデプロイメントと設定を管理できます。 [[!DNL Global Admin Console]](https://helpx.adobe.com/enterprise/global-admin-console/overview.html)では、グローバル管理者が複数の組織を作成、管理、削除できます。

## 子組織の作成

[ グローバル管理者](https://helpx.adobe.com/enterprise/global-admin-console/manage-administrators.html)として、階層内の任意の組織の子組織を作成し、名前、国、ユーザーグループ、製品、製品プロファイル、管理者、ポリシーを設定できます。
...
- 親組織がアクセスできるドメインから[[!DNL Federated ID]]または[[!DNL Enterprise ID]] ユーザーにアクセスします。 これにより、親内のドメインユーザーを子組織で使用できるようになります。 ユーザーアクセスの継承は、**親組織が管理するディレクトリからユーザーを継承** [ ポリシー](https://helpx.adobe.com/enterprise/global-admin-console/update-policies.html)によって制御されます。
...
[ グローバル管理者](https://helpx.adobe.com/enterprise/global-admin-console/manage-administrators.html)として、子組織を削除できます。 削除操作を元に戻すことはできず、ルート組織を削除することはできません。 削除された組織に割り当てられたリソースは、その親組織に返されます。 組織が削除される前に、その親は自動的にその子組織の親になります。
...
[ グローバル管理者](https://helpx.adobe.com/enterprise/global-admin-console/manage-administrators.html)は、任意の親組織または子組織の名前を編集して、[[!DNL Creative Cloud]]製品およびサービスにログインする際にユーザーが正しいプロファイルを識別できるようにすることができます。
...
変更は監査ログに記録され、すべてのユーザーに電子メールで通知され、名前を24時間更新することはできません。 [監査ログの表示およびダウンロード方法について説明します](https://helpx.adobe.com/enterprise/global-admin-console/insights.html)。

## 組織の親を変更

[!DNL Global Administrator](https://helpx.adobe.com/enterprise/global-admin-console/manage-administrators.html)様は、**[!UICONTROL 階層を変更]** ボタンを使用して、組織階層の組織を再ペアレント化できます。
...
[ グローバル管理者](https://helpx.adobe.com/enterprise/global-admin-console/manage-administrators.html)は、現在Global Admin Console階層に含まれていない既存の組織を組織階層に追加できます。
...
2. ドロップダウンリストから親組織を選択します。\
   これらは、グローバル管理者として直接追加される組織です。 ドロップダウンリストで、親として使用する組織が表示されない場合は、階層内で上位の組織を1つ選択します。 組織マッパー操作が完了したら、[階層を変更](https://helpx.adobe.com/enterprise/global-admin-console/set-up-organizations.html#change-the-parent-of-an-organization)して、新しい組織をツリー内で下に移動し、使用する親を持たせることができます。
