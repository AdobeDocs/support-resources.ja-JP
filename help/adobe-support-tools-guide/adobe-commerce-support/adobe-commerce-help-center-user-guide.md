...
Adobe Experience League のスタートページを使用して新しいサポートケースを送信するには、[Experience Leagueでサポートチケットを作成する &#x200B;](https://experienceleague.adobe.com/ja/docs/support-resources/adobe-support-tools-guide/adobe-customer-support-experience#create-a-support-ticket-with-experience-league) を参照してください。
...
1. ユーザーがまだ **[!UICONTROL クラウド共有アクセス]** を持っているかどうかについて混乱を避けるために、**[!UICONTROL 共有名]** を次のような名前に変更する必要があります。例えば、*クラウド共有アクセスの失効 – 削除できません* などです。
...
サポートナレッジベースの [&#x200B; 共有アクセスのトラブルシューティングの記事 &#x200B;](https://experienceleague.adobe.com/ja/docs/commerce-knowledge-base/kb/troubleshooting/miscellaneous/shared-access-troubleshooting) を参照してください。
