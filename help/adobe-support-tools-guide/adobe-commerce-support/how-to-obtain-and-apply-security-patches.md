...
* Commerce Cloud Tools Suite[&#128279;](https://experienceleague.adobe.com/en/docs/commerce-cloud-service/user-guide/release-notes/cloud-tools-suite)の リリースノート（*Adobe Commerce on Cloud Infrastructure ガイド*）を参照してください。
* *Adobe Commerce on Cloud Infrastructure ガイド*&#x200B;の「[Adobe Commerce バージョンをアップグレードする](https://experienceleague.adobe.com/en/docs/commerce-cloud-service/user-guide/develop/upgrade/commerce-version)」を参照してください。
