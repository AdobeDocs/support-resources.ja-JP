...
2. **[!UICONTROL Magento]**/**[!UICONTROL 製品とサービス]**/**[!UICONTROL Magento Business Intelligence]** をクリックし、更新するライセンスの横にある **[!UICONTROL 詳細を表示]** をクリックします。
3. **[!UICONTROL 支払い方法の更新]** または **[!UICONTROL ライセンスのキャンセル]** を選択します。
