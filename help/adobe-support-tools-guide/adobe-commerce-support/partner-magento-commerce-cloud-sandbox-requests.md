...
サポートナレッジベースの [&#x200B; クラウド上の環境のリセット &#x200B;](https://experienceleague.adobe.com/ja/docs/commerce-knowledge-base/kb/how-to/reset-environment-on-cloud) を参照してください。
...
[Experience Leagueのサポート セクション &#x200B;](https://experienceleague.adobe.com/ja/support?support-tab=home#home) でサポートチケットを送信します。
