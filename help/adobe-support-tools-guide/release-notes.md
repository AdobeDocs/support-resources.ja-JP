...
1. UI スイッチャーラベルが&#x200B;**[UICONTROLから更新されました。新しいホームページを試す]**&#x200B;から&#x200B;**[UICONTROL前のエクスペリエンス]**&#x200B;に戻って、より明確にできます。

1. ポータルの環境設定は、**[UICONTROL以前のエクスペリエンスに戻る]** スイッチャーの選択に基づいて引き続き保存および適用されるため、ユーザーは訪問ごとに最後に選択したポータルのエクスペリエンスに誘導されます。
