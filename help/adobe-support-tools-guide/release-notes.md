...
1. UI スイッチャーラベルが&#x200B;**[!UICONTROL から更新されました。新しいホームページを試す]**&#x200B;から&#x200B;**[!UICONTROL 前のエクスペリエンス]**&#x200B;に戻って、より明確にできます。

1. ポータルの環境設定は、**[!UICONTROL 以前のエクスペリエンスに戻る]** スイッチャーの選択に基づいて引き続き保存および適用されるため、ユーザーは訪問ごとに最後に選択したポータルのエクスペリエンスに誘導されます。

1. 新しい&#x200B;**[!UICONTROL All Time]** オプションが、**[!UICONTROL My Cases]** ページの&#x200B;**[!UICONTROL Time Range]** フィルタードロップダウンに導入され、過去24か月間を超えてケース履歴を完全に表示できるようになりました。
