...
>[!NOTE]
>
>このページでは、Adobe Customer Experience Orchestration （CXO）ソリューションのサポートチケットを作成および管理する方法について説明します。 Adobe Creative Cloud ソリューションのサポート情報については、[ここをクリック &#x200B;](https://helpx.adobe.com/support.html)してください。
